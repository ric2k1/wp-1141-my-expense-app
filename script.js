...
function setCurrentDateTime() {
  ...
  const dateTimeString = `${year}-${month}-${day} : ${hour12}${
    minute !== "00" ? ":" + minute : ""
  }${ampm}`;
...
function showEmptyStatistics() {
  statisticsRows.innerHTML =
    '<div class="statistics-row"><div class="statistics-cell" style="text-align: center; color: #6c757d; font-style: italic;">尚無支出記錄</div><div class="statistics-cell"></div></div>';
